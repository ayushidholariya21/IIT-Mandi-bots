...
This repository contains various robot projects developed as part of the IIT Mandi course curriculum. Each project contains source code (`.ino` files), project documentation, and demo media (images/videos).

## Projects Included

### 1. [Line Following Bot](./Line%20Following%20Bot)
A robot designed to follow a black line on a white background (or vice versa) using infrared (IR) sensors to detect the path.
- **Source Code**: [`linefollowing.ino`](./Line%20Following%20Bot/linefollowing.ino)
- **Documentation**: [`Line Following Robot.pdf`](./Line%20Following%20Bot/Line%20Following%20Robot.pdf)
- **Demo Video**: [`Demo_Line_following_Bot.mp4`](./Line%20Following%20Bot/Demo_Line_following_Bot.mp4)
...
To program these robots:
1. Install the Arduino IDE.
2. Clone this repository:
   ```bash
   git clone https://github.com/ayushidholariya21/IIT-Mandi-bots.git
   ```
3. Open the corresponding `.ino` file in Arduino IDE.
4. Upload the code to your microcontrollers (e.g., Arduino Uno, ESP32).
